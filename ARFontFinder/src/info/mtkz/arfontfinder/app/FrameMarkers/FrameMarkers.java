    ...
    SampleAppMenuInterface
{
    ...
    private final static int _NUM_OF_KANA_FONTS = 92 + 1;
    ...
    {
//        mTextures.add(Texture.loadTextureFromApk("FrameMarkers/cube.png",
//            getAssets()));
...
//        
        ...
        for(int i = 0; i < _NUM_OF_KANA_FONTS ; i++ ){
        	//mTextures.add(Texture.loadTextureFromApk("FrameMarkers/cube.png", getAssets()));
        	mTextures.add(Texture.loadTextureFromApk("FrameMarkers/jakana/" + i + ".png", getAssets()));
        }
    }
    ...
    public boolean doLoadTrackersData()
    {
        ...
        dataSet = new Marker[_NUM_OF_KANA_FONTS];
        for(int i = 0; i < _NUM_OF_KANA_FONTS ; i ++ ){
